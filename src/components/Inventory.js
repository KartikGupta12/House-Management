...
function Inventory() {
    ...
    return (
        ...
        <h2 className='demo-4 main'>This Month data</h2>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            {/* <label htmlFor="product"><h5>Products</h5></label>
                            <select  id="product" className="form-select">
                                <option disabled selected>Select Product to edit</option>
                                {details.map((data, index) => <option value={data.name} key={index}> {data.name} </option>)}
                            </select> */}
                            ...
                            <div className='form-container'>
                                <form className="EnterProduct-Form" >
                                    ...
                                    <div className="form-floating mb-3">
                                        <select id="product"  onChange={onchange} value={newdetails.product_name} name="product_name" className="form-select">
                                    ...
                                    <div className="form-floating mb-3">
                                        <input type="number" name="new_quantity" id="quantity" placeholder='Not Used' 
                                            ...
                                            className="form-control" value={newdetails.new_quantity}  onChange={onchange} />
...

            {
                Products.map((data, index) =>
                    <Acordion key={index} category={data.category} details={data.product} number={acordionNum[index]} handleclick={handleclick} />
                )
            }
        </>
    );
